...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(
            home
            + "/proclogic_api/scripts/backfill_contracts/contract_backfill_2023_jan_dec.log"
        ),
...
PROGRESS_FILE = (
    home
    + "/proclogic_api/scripts/backfill_contracts/backfill_progress_2023_jan_dec.json"
)
